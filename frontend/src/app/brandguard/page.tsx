...
import type { Template } from '@/lib/brandguard-api'
      ...
      <header className="border-b border-[var(--neutral-200)] bg-white/80 backdrop-blur-md sticky top-0 z-50">
        <div className="container-luxury py-4 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-6">
            <Link href="/facesim" className="text-sm text-[var(--neutral-500)] hover:text-[var(--brand-primary)] transition-colors">
              FaceSim
            </Link>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <section className="card p-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 className="text-lg font-medium text-[var(--neutral-800)]">选择模板</h2>
                  <p className="text-sm text-[var(--neutral-500)]">选择符合品牌调性的海报模板</p>
                </div>
              </div>
              <TemplateSelector
            ...
            {selectedTemplate && (
              <section className="card p-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h2 className="text-lg font-medium text-[var(--neutral-800)]">编辑海报</h2>
                    <p className="text-sm text-[var(--neutral-500)]">输入文案，AI 自动生成海报</p>
                  </div>
                </div>
                <PosterEditor
          ...
          <div className="space-y-6">
            ...
            <section className="card p-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 className="text-lg font-medium text-[var(--neutral-800)]">合规检测</h2>
                  <p className="text-sm text-[var(--neutral-500)]">实时违禁词审查</p>
                </div>
              </div>
            ...
            {previewUrl && (
              <section className="card p-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h2 className="text-lg font-medium text-[var(--neutral-800)]">导出选项</h2>
                    <p className="text-sm text-[var(--neutral-500)]">多尺寸适配导出</p>
                  </div>
                </div>
            ...
            <section className="card p-6 bg-gradient-to-br from-[var(--brand-secondary)] to-white border-[var(--brand-primary)]/20">
              <h3 className="text-sm font-medium text-[var(--neutral-800)] mb-4">品牌色规范</h3>
              <div className="space-y-3">
                {[
                  ...
                  <div key={item.name} className="flex items-center gap-3">
                    ...
                    />
                    <div>
                      <p className="text-sm text-[var(--neutral-700)]">{item.name}</p>
                      <p className="text-xs text-[var(--neutral-400)] font-mono">{item.color}</p>
                    </div>
                  </div>
                ))}
              </div>
